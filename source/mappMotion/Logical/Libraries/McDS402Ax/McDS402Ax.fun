FUNCTION_BLOCK MC_BR_InitHome_DS402Ax (*initializes homing parameter for usage with MC_Home*)
	VAR_INPUT
		Axis : REFERENCE TO McAxisType; (*axis reference*)
		Execute : BOOL; (*execution of this FB is started on rising edge of the input*)
		HomingParameters : McDS402AxHomingParType; (*parameter used with MC_Home if HomingMode=mcHomeInit*)
	END_VAR
	VAR_OUTPUT
